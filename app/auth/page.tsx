...
import { signInWithGoogle } from "@/app/api/authApi";
      ...
      >
        <div className="w-full max-w-md">
          ...
          >
            ...
            <span className="px-4 text-gray-400 text-sm font-sans">hoặc tiếp tục với</span>
            <div className="flex-1 h-px bg-gray-300"></div>
          </motion.div>
          ...
          >
            <button
              ...
              className={`w-full flex items-center justify-center gap-3 py-4 px-6 bg-white border-2 border-gray-200 rounded-xl font-sans font-semibold text-sm text-[#1F2937] shadow-sm transition-all duration-300 hover:bg-gray-50 hover:border-gray-300 hover:shadow-md ${
            ...
            >
              {isGoogleLoading ? (
                <span className="flex items-center justify-center">
                  <svg
                    className="animate-spin -ml-1 mr-3 h-5 w-5 text-[#9B1B1B]"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
          ...
          <motion.p
            ...
            className="text-center text-gray-500 font-sans mt-6"
          >
